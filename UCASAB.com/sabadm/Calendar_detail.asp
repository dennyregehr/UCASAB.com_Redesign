...
' ***********************************
' Page Name: Calendar_detail.asp
' Date: 3/4/2005 12:28:25 AM
...
ElseIf Request("btnSubmit") = "Delete" Or Request("fnc") = "delete" And sErr = "" Then
	...
	Else
		...
		Response.Clear: Response.Redirect "Calendar_results.asp" & GetQueryString("Detail", Empty, Empty, Empty, Empty) & "&msg=" & Server.URLEncode(sMsg) & "&err=" & Server.URLEncode(sErr)
	End If
ElseIf  Request("btnDelete") = "Delete Checked Records" Then
	...
	If iRecordsDeleted = 0 Then
		...
		Response.Clear: Response.Redirect "Calendar_results.asp" & GetQueryString("Detail", Empty, Empty, Empty, Empty) & "&msg=" & Server.URLEncode(sMsg)
...
If Request("fnc") <> "add" And Request("DB2ASPAction") <> "Add" Then
	...
	If iPosition = "-1" Or iPosition = "" Then
		sWhere = " WHERE " & _
		"[EventID]=" & Replace(Request("PK_iEventID"), "'", "''") & " "
	End If
	...
	End If
		...
		vEventID = oRS("EventID")
		vEventName = oRS("EventName")
		vEventTypeID = oRS("EventTypeID")
		vLocation = oRS("Location")
		vStartDate = oRS("StartDate")
		vEndDate = oRS("EndDate")
		vStartTime = oRS("StartTime")
		vEndTime = oRS("EndTime")
		vEventDescription = oRS("EventDescription")
		vNotes = oRS("Notes")
		vimageURL = oRS("imageURL")
		vwebsite = oRS("website")
		vvideoURL = oRS("videoURL")
		vaudioURL1 = oRS("audioURL1")
		vaudioURL2 = oRS("audioURL2")

	If Err Then
		'Response.Redirect "Calendar_results.asp" & GetQueryString("Detail", Empty, Empty, Empty, Empty) & "&err=Error On Detail Page (" & Err.Description & " [" & Err.Number & "])"
...
<FORM name=frmDetail method=post action="Calendar_detail.asp<%=GetQueryString("Detail", Empty, Empty, Empty, Empty)%>">
<TABLE cellspacing=1 class=DB2ASP>
	<TR>
		<TD colspan=9 class=DB2ASPlight>
			<TABLE cellspacing=1 class=menu width=100%><TR>
			<TD class=menu>
				<SPAN class=DB2ASPtitle>Calendar</SPAN>
			</TD>
			<TD align=right class=menu width=120>
				<A href="Calendar_search.asp<%=GetQueryString("Detail", Empty, Empty, Empty, Empty)%>" title="Search For Specific Records" class=DB2ASPvalue>Search</A><br>
				<A href="Calendar_results.asp<%=GetQueryString("Detail", Empty, Empty, Empty, Empty)%>" title="Last Results View of Records" class=DB2ASPvalue>Last Results View</A><br>
...
<TR>
	<TH align=right class=DB2ASPdark>EventID</TH>
	<TD class=DB2ASPdetailcellbg>
		<%=vEventID%>&nbsp;
	</TD>
</TR>
<TR>
	<TH align=right class=DB2ASPdark>EventName</TH>
	<TD class=DB2ASPdetailcellbg>
		<INPUT type=text name="EventName" SIZE=60 MAXLENGTH=255 value="<%=vEventName%>" class=DB2ASPdetailinput>
	</TD>
</TR>
<TR>
	<TH align=right class=DB2ASPdark>EventTypeID</TH>
	<TD class=DB2ASPdetailcellbg>
			<%=LookupEventTypeeventTypeID(vEventTypeID, "Drop Down List", 1, Empty, "EventTypeID")%>&nbsp;
	</TD>
</TR>
<TR>
	<TH align=right class=DB2ASPdark>Location</TH>
	<TD class=DB2ASPdetailcellbg>
		<INPUT type=text name="Location" SIZE=60 MAXLENGTH=255 value="<%=vLocation%>" class=DB2ASPdetailinput>
	</TD>
</TR>
<TR>
	<TH align=right class=DB2ASPdark>StartDate</TH>
	<TD class=DB2ASPdetailcellbg>
		<INPUT type=text name="StartDate" SIZE=20 MAXLENGTH=30 value="<%=vStartDate%>" class=DB2ASPdetailinput>
	</TD>
</TR>
<TR>
	<TH align=right class=DB2ASPdark>EndDate</TH>
	<TD class=DB2ASPdetailcellbg>
		<INPUT type=text name="EndDate" SIZE=20 MAXLENGTH=30 value="<%=vEndDate%>" class=DB2ASPdetailinput>
	</TD>
</TR>
<TR>
	<TH align=right class=DB2ASPdark>StartTime</TH>
	<TD class=DB2ASPdetailcellbg>
		<INPUT type=text name="StartTime" SIZE=20 MAXLENGTH=30 value="<%=vStartTime%>" class=DB2ASPdetailinput>
	</TD>
</TR>
<TR>
	<TH align=right class=DB2ASPdark>EndTime</TH>
	<TD class=DB2ASPdetailcellbg>
		<INPUT type=text name="EndTime" SIZE=20 MAXLENGTH=30 value="<%=vEndTime%>" class=DB2ASPdetailinput>
	</TD>
</TR>
<TR>
	<TH align=right class=DB2ASPdark>EventDescription</TH>
	<TD class=DB2ASPdetailcellbg>
		<TEXTAREA name="EventDescription" COLS=58 ROWS=5><%=vEventDescription%></TEXTAREA>
	</TD>
</TR>
<TR>
	<TH align=right class=DB2ASPdark>Notes</TH>
	<TD class=DB2ASPdetailcellbg>
		<TEXTAREA name="Notes" COLS=58 ROWS=5><%=vNotes%></TEXTAREA>
	</TD>
</TR>
<TR>
	<TH align=right class=DB2ASPdark>imageURL</TH>
	<TD class=DB2ASPdetailcellbg>
		<INPUT type=text name="imageURL" SIZE=60 MAXLENGTH=255 value="<%=vimageURL%>" class=DB2ASPdetailinput>
		<a href="uploader.aspx" target="_blank">Upload</a>
	</TD>
</TR>
<TR>
	<TH align=right class=DB2ASPdark>website</TH>
	<TD class=DB2ASPdetailcellbg>
		<INPUT type=text name="website" SIZE=60 MAXLENGTH=100 value="<%=vwebsite%>" class=DB2ASPdetailinput>
	</TD>
</TR>
<TR>
	<TH align=right class=DB2ASPdark>videoURL</TH>
	<TD class=DB2ASPdetailcellbg>
		<INPUT type=text name="videoURL" SIZE=60 MAXLENGTH=255 value="<%=vvideoURL%>" class=DB2ASPdetailinput>
	</TD>
</TR>
<TR>
	<TH align=right class=DB2ASPdark>audioURL1</TH>
	<TD class=DB2ASPdetailcellbg>
		<INPUT type=text name="audioURL1" SIZE=60 MAXLENGTH=255 value="<%=vaudioURL1%>" class=DB2ASPdetailinput>
	</TD>
</TR>
<TR>
	<TH align=right class=DB2ASPdark>audioURL2</TH>
	<TD class=DB2ASPdetailcellbg>
		<INPUT type=text name="audioURL2" SIZE=60 MAXLENGTH=255 value="<%=vaudioURL2%>" class=DB2ASPdetailinput>
	</TD>
</TR>
...
<BR><BR>
<INPUT type=hidden name="PK_iEventID" value='<%=vEventID%>'>
...
<% End If %>
<INPUT type=Submit name=btnBack value="Back To Results" onClick="javascript: document.location.href='Calendar_results.asp<%=GetQueryString("Detail", Empty, Empty, Empty, Empty)%>'; return false;" class=DB2ASPactionbtn>&nbsp;&nbsp;
...
<!-- #INCLUDE file="includes/pages/DB2ASP_Calendar_functions.asp" -->
