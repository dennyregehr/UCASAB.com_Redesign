<%@ Page Title="" Language="VB" MasterPageFile="~/Masterpages/MasterPage.master" AutoEventWireup="false" CodeFile="Movies.aspx.vb" Inherits="Movies" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta property="og:title" content="UCA Student Activities Board Movies"/>
    <meta property="og:description"
          content="The University of Central Arkansas is full of movie fanatics! The Student Activities Board feeds your movie madness by bringing the hottest movies to campus before you can get them from the local Red-colored-Box."/>
    ...
    <meta property="og:url" content="http://www.ucasab.com/movies.aspx"/>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="PageTextHeading">
        ...
        <fb:like layout="button_count" show_faces="false" fb_ref="movies" colorscheme="light"></fb:like>
    </div>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        ...
        TypeName="EventUtil">
        <SelectParameters>
            <asp:Parameter Name="EventTypeId" DefaultValue="4" />
        </SelectParameters>
    </asp:ObjectDataSource>
    
    <uc1:ChairBoxLinks runat="server" ID="ChairBoxLinks" />
