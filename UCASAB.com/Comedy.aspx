<%@ Page Title="" Language="VB" MasterPageFile="~/Masterpages/MasterPage.master" AutoEventWireup="false" CodeFile="Comedy.aspx.vb" Inherits="Comedy" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <meta property="og:title" content="UCA Student Activities Board Comedy"/>
    <meta property="og:description"
          content="The University of Central Arkansas enjoys a hearty laugh, and the Student Activities Board 
            is happy to oblige your need for chuckles.  SAB brings up-and-coming comedians and well-known
            comics to the UCA campus for the student body and the local community."/>
    ...
    <meta property="og:url" content="http://www.ucasab.com/comedy.aspx"/>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="PageTextHeading">
        Comedy Shows
        <fb:like layout="button_count" show_faces="false" fb_ref="comedy" colorscheme="light"></fb:like>
    </div>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
        ...
        TypeName="EventUtil">
        <SelectParameters>
            <asp:Parameter Name="EventTypeId" DefaultValue="2" />
        </SelectParameters>
